...
project = "Z2Pack"
copyright = f"2015-{time.localtime().tm_year}, Dominik Gresch"
...
latex_documents = [
    ("index", "Z2Pack.tex", "Z2Pack Documentation", "Dominik Gresch", "manual"),
]
...
man_pages = [("index", "z2pack", "Z2Pack Documentation", ["Dominik Gresch"], 1)]
