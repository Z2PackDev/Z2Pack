...
import z2pack
from z2pack._json_encoding import SurfaceResultEncoder
...
res0 = z2pack.surface.run(system=system0, surface=surface, iterator=list(range(8, 47, 2)))
res1 = z2pack.surface.run(system=system1, surface=surface)

with open('test.json', 'w') as f:
    json.dump(res0, f, cls=SurfaceResultEncoder)
