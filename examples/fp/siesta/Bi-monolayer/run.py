...
result = z2pack.surface.run(system=system, surface=surface, save_file="./res.json", **settings)
...
z2pack.plot.wcc(result, axis=ax, wcc_settings=wcc_settings, gap_settings=gap_settings)
