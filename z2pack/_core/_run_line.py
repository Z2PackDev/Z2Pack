...
class _RunLineImpl(object):
    ...
    def __init__(self, system, line, pos_tol, iterator, verbose, result, werr):
        ...
        self.werr = werr
        # create descriptor for System, Line
        ...
        # create LineResult object or check for consistency.
        if result is None:
        ...
        self.print_vars = {'pos_tol': self.pos_tol, 'iterator': list(iterator), 'verbose': self.verbose, 'werr': self.werr, 'descriptor': self.descriptor}
    ...
    def run(self):
        ...
        # FINAL OUTPUT
        # reduced & full
        if self.verbose in ['full', 'reduced']:
    ...
    def _param_check(self):
        ...
        if self.verbose is True:
            ...
            self.verbose = 'none'
        if not self.verbose in ['full', 'reduced', 'none']:
            raise ValueError('unknown verbosity level {0}'.format(self.verbose))
