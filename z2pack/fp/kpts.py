...
def prototype(start_point, last_point, end_point, N):
    ...
    :param end_point:       End point of the string of k-points. This k-point is connected to ``start_point`` by a reciprocal lattice vector in the direction of the string of k-points. ``end_point`` itself should not be used in the calculation.
